...
@Composable
fun IndividualsList(individualsList: List<IndividualDTO>, navController: NavController) {
...
@Composable
fun IndividualItem(individual: IndividualDTO, navController: NavController) {
